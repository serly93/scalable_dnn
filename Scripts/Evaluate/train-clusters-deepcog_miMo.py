...
os.environ['CUDA_VISIBLE_DEVICES'] = "2"  # Set the GPU card to use
...
def myMultiOpt(pair):
    ...
    model_dir = f'../../../../oracle-data/serly/Scalable_dnn/Trained_models/DeepCOG_miMo/random_selection_{random_flag}/{city}/k_{k}'
